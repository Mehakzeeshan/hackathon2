  ...
  return (
    <>
      ...
      <section className="mt-16">
        ...
        <Image src="/sofaset.png" alt="sofa set" width={1000} height={1000} className="mt-12 md:ml-28" />
      </section>

      <section className="border-t border-[#9f9f9f] mt-12">
        <h2 className="mt-14 text-center text-4xl font-semibold">Related Products</h2>
